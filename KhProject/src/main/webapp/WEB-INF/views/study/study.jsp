...
<body>
	...
	<pre>
		...
		진짜로 자바스크립트 객체 XXXXXXXXXXXXXXX 자바스크립트 객체 모양으로 문자열을 만든거
	
		문법이 아주 엄격함!!! 자바 스크립트 객체
		{
	...
	<pre>
		* jQuery를 사용한 AJAX 통신
		...
		$.ajax({
			...
			속성명 : 값,
			...
		}); ============> 4일동안 숙제 : Web으로 CRUD 구현 + 인터페이스/다형성/J.S 복습
	...
	<script>
		...
		$('#btn1').click(function(){
			// 동기식 요청
			//location.href = "ajax1.do?input1=ㅇㅇㅇ"
