...
public class Employee {
	...
	public String toString() {
		return "Employee [empId=" + empId + ", empName=" + empName + ", empNo=" + empNo + ", phone=" + phone
	...
	@Override
	public int hashCode() {
		return Objects.hash(bonus, deptCode, empId, empName, empNo, entDate, entYn, hireDate, jobCode, phone, salLevel,
				salary);
	}
	...
	public boolean equals(Object obj) {
		...
		return Double.doubleToLongBits(bonus) == Double.doubleToLongBits(other.bonus)
				&& Objects.equals(deptCode, other.deptCode) && empId == other.empId
