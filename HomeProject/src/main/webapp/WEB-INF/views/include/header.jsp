...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-info-subtle text-info-emphasis">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">KHCOMPUTER</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <c:otherwise>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="edit">정보수정</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="logout" onclick="return confirm('정말로 로그아웃 합니까?')">로그아웃</a>
        </li>
        </c:otherwise>
        </c:choose>
